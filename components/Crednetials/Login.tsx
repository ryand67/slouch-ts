    ...
    return (
        <div className="w-full">
            <form onSubmit={(e) => handleSignIn(e)} className="flex flex-col w-full">
                ...
                <p onClick={() => changeCredState(false)} className="text-center my-6">Don't have an account? <span className="cursor-pointer underline text-green-400">Sign up!</span></p>
                <button onClick={(e) => handleSignIn(e)} className="rounded bg-green-300 w-44 mx-auto py-3 text-white hover:bg-white hover:text-green-300 transition-all border-4 border-green-300" type="submit">Sign In</button>
            </form>
        </div>
    )
}
